      ...
      for (let x = 0; x < 8; x++) {
        for (let y = 0; y < 8; y++) {
          ...
          if (piece.canMoveTo[x][y]) {
            ...
            // Alpha represents the minimum best value.
            // Beta represents the maximum best value.
            // Alpha: It is the best choice so far for the player MAX and it has to be the highest possible value.
            // Beta: It is the best choice so far for the player MIN and it has to be the lowest possible value.
            // In simpler terms, Alpha represents the best score found for the maximizing player so far and Beta represents the best score found for the minimizing player so far.
          }
        }
      }
    }
